...
OpenMRF offers the possibility to calibrate your trajectory. This feature is especially relevant if you're using demanding gradient operations at higher field strengths. In the following, we'll outline the process in five easy steps. 
